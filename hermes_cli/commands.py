...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("approvals", "List pending owner approval requests", "Session",
               gateway_only=True),
    CommandDef("memory-migrate", "Create owner approval to migrate legacy USER.md memory", "Session",
               gateway_only=True, args_hint="[owner]"),
    CommandDef("approve", "Approve a pending dangerous command", "Session",
               gateway_only=True, args_hint="[id|session|always]"),
    CommandDef("deny", "Deny a pending dangerous command", "Session",
               gateway_only=True, args_hint="[id] [reason]"),
    ...
    CommandDef("audit", "Show recent owner policy audit events", "Info",
               gateway_only=True, args_hint="[N]"),
    CommandDef("permissions", "Show resolved owner/correspondent policy for a principal", "Info",
               gateway_only=True, args_hint="[principal]"),
    CommandDef("users", "Manage owner/correspondent principal mappings", "Configuration",
               gateway_only=True, args_hint="set <principal> <relationship> [owner] [policy]",
               subcommands=("set",)),
